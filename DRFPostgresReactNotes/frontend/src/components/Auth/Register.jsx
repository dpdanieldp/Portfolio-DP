...
export const Register = () => {
    ...
    const onSubmit = async (values) => {
        try {
            await axiosInstance.post('/users/new/', values)
            toast({
        ...
        >
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <FormControl isInvalid={errors.password}>
                    <Input
                        placeholder="Username" background={useColorModeValue('gray.300', 'gray.600')} type="text"
                        variant="filled"
                        size="lg"
                        mt={6}
                        {...register("username", {
                ...
                <FormControl isInvalid={errors.password}>
                    <Input
                        placeholder="Password" background={useColorModeValue('gray.300', 'gray.600')} type="password" size="lg" mt={6}
                        {...register("password", {
                            required: "This is required field",
                            minLength: {
                                value: 5,
                                message: "Password must be at least 5 chaarcters long"
                            },
                            maxLength: {
                                value: 24,
                ...
                <FormControl isInvalid={errors.password2}>
                    <Input
                        placeholder="Confirm password" background={useColorModeValue('gray.300', 'gray.600')} type="password" size="lg" mt={6}
                        {...register("password2", {
                            required: "This is required field",
                            minLength: {
                                value: 5,
